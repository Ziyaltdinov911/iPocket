...
class MainScreenView: UIViewController {
    ...
    private lazy var topInsets: CGFloat = 0
    
    private lazy var menuViewHeight = UIApplication.topSafeArea + 70
...
extension MainScreenView: UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        ...
        header.setHeaderText(header: presenter.posts?[indexPath.section].date.getDateDifference())
